...
class DestinyManifest(BaseModel):
    ...
    Attributes:
        version: _No description given_
        mobile_asset_content_path: _No description given_
        mobile_gear_asset_data_bases: _No description given_
        mobile_world_content_paths: _No description given_
        ...
        mobile_clan_banner_database_path: _No description given_
        mobile_gear_c_d_n: _No description given_
