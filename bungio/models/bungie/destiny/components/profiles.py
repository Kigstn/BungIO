...
class DestinyProfileTransitoryComponent(BaseModel):
    ...
    current_activity: Any = attr.field()
    joinability: Any = attr.field()
...
class DestinyProfileTransitoryTrackingEntry(BaseModel):
    ...
    It's up to you to interpret what it means when various combinations of these entries have values being tracked.
        ...
        Attributes:
            ...
            tracked_date: OPTIONAL - I've got to level with you, I don't really know what this is. Is it when you started tracking it? Is it only populated for tracked items that have time limits?
