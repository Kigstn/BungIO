...
class DestinySocketTypeDefinition(BaseModel):
    ...
    Attributes:
        ...
        socket_category_hash: _No description given by bungie_
        ...
        always_randomize_sockets: _No description given by bungie_
        is_preview_enabled: _No description given by bungie_
        hide_duplicate_reusable_plugs: _No description given by bungie_
        ...
        avoid_duplicates_on_initialization: _No description given by bungie_
        currency_scalars: _No description given by bungie_
...
class DestinySocketTypeScalarMaterialRequirementEntry(BaseModel):
    ...
    Attributes:
        currency_item_hash: _No description given by bungie_
