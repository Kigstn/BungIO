...
class DestinySocketTypeDefinition(BaseModel):
    ...
    Attributes:
        ...
        socket_category_hash: _No description given_
        ...
        always_randomize_sockets: _No description given_
        is_preview_enabled: _No description given_
        hide_duplicate_reusable_plugs: _No description given_
        ...
        avoid_duplicates_on_initialization: _No description given_
        currency_scalars: _No description given_
...
class DestinySocketTypeScalarMaterialRequirementEntry(BaseModel):
    ...
    Attributes:
        currency_item_hash: _No description given_
        scalar_value: _No description given_
    """
