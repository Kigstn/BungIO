...
class DestinyChecklistEntryDefinition(BaseModel):
    ...
    Attributes:
        ...
        destination_hash: _No description given_
        location_hash: _No description given_
        ...
        vendor_hash: _No description given_
        vendor_interaction_index: _No description given_
