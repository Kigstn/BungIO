...
class DestinyChecklistEntryDefinition(BaseModel):
    ...
    Whatever UI you build, do it with the knowledge that any given entry might not actually be able to be associated with some other Destiny entity.
        ...
        Attributes:
            ...
            destination_hash: Not specified.
            location_hash: Not specified.
            bubble_hash: Note that a Bubble's hash doesn't uniquely identify a "top level" entity in Destiny. Only the combination of location and bubble can uniquely identify a place in the world of Destiny: so if bubbleHash is populated, locationHash must too be populated for it to have any meaning.
    ...
    You can use this property if it is populated to look up the DestinyLocationDefinition's associated .locationReleases[].activityBubbleName property.
            ...
            vendor_hash: Not specified.
            vendor_interaction_index: Not specified.
