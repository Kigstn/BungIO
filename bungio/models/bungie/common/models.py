...
class Destiny2CoreSettings(BaseModel):
    ...
    manifest_active_seals_root_node_hash: Optional["DestinyPresentationNodeDefinition"] = attr.field()
    manifest_active_triumphs_root_node_hash: Optional["DestinyPresentationNodeDefinition"] = attr.field()
    manifest_badges_root_node: Optional["DestinyPresentationNodeDefinition"] = attr.field()
    manifest_collection_root_node: Optional["DestinyPresentationNodeDefinition"] = attr.field()
    ...
    manifest_current_seasonal_artifact_hash: Optional["DestinyVendorDefinition"] = attr.field()
    manifest_exotic_catalysts_root_node_hash: Optional["DestinyPresentationNodeDefinition"] = attr.field()
    manifest_legacy_seals_root_node_hash: Optional["DestinyPresentationNodeDefinition"] = attr.field()
    manifest_legacy_triumphs_root_node_hash: Optional["DestinyPresentationNodeDefinition"] = attr.field()
    manifest_lore_root_node_hash: Optional["DestinyPresentationNodeDefinition"] = attr.field()
    manifest_medals_root_node: Optional["DestinyPresentationNodeDefinition"] = attr.field()
    manifest_medals_root_node_hash: Optional["DestinyPresentationNodeDefinition"] = attr.field()
    manifest_metrics_root_node: Optional["DestinyPresentationNodeDefinition"] = attr.field()
    manifest_records_root_node: Optional["DestinyPresentationNodeDefinition"] = attr.field()
