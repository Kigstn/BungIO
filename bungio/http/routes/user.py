...
class UserRouteHttpRequests:
    ...
    async def get_sanitized_platform_display_names(self, membership_id: int, auth: Optional[AuthData] = None) -> dict:
        """
    ...
    async def get_membership_data_for_current_user(self, auth: AuthData) -> dict:
        """
