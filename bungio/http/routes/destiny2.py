...
class Destiny2Requests:
    ...
    async def get_clan_banner_source(self, auth: Optional[AuthData] = None) -> dict:
        ...
        return await self.request(Route(path=f"/Destiny2/Clan/ClanBannerDictionary/", method="GET", auth=auth))
    ...
    async def get_public_vendors(self, components: Optional[list[int]] = None, auth: Optional[AuthData] = None) -> dict:
        """
        ...
        return await self.request(Route(path=f"/Destiny2/Vendors/", method="GET", components=components, auth=auth))
    ...
    async def get_historical_stats_definition(self, auth: Optional[AuthData] = None) -> dict:
        ...
        return await self.request(Route(path=f"/Destiny2/Stats/Definition/", method="GET", auth=auth))
